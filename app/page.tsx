...
export default function Home() {
	return (
		<main className='max-w-screen-lg max-auto  shadow-lg shadow-white/40 rounded-md flex flex-col min-h-[500px] max-h-[600px] h-full overflow-hidden'>
			...
			<div className='w-full h-42 overflow-y-scroll no-scrollbar p-4 bg-black/45'>
				<Terminal />
			</div>
		</main>
	);
